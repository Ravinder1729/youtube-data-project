...
icon = Image.open(r"C:\Users\ravin\OneDrive\Desktop\Youtube_logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by ravinder!*"""})

# CREATING OPTION MENU
with st.sidebar:
    selected = option_menu(None, ["Home","Extract & Transform","View"],
                           icons=["book-fill","box","bell-fill"],
                           default_index=0,
...
#mongodb connection & creating database
...
mycursor = mydb.cursor(buffered=True)
 #api connection:
api_key ="AIzaSyCwwQwqYFFsGI_qBElKKHdx3r8hGhj3VkE"

youtube = build('youtube', 'v3', developerKey=api_key)

# getting chaneel detais
...
def get_comments_details(v_id):
    ...
    try:
        ...
        pass
    return comment_data
#getting channel names from mongodb:
def channel_names():
    ch_name = []
...
if selected == "Home":
    # Title Image
    st.image(r"C:\Users\ravin\OneDrive\Desktop\Youtube_logo.png")
...
if selected == "Extract & Transform":
    tab1, tab2 = st.tabs(["$\small 📝 EXTRACT $", "$\small🚀 TRANSFORM $"])
    # EXTRACT TAB
    with tab1:
        st.markdown("#    ")
        st.write("### Enter YouTube Channel_ID below :")
        ch_id = st.text_input("Enter your channel_id:")
